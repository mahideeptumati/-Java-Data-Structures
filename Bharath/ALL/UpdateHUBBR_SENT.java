...
public class  UpdateHUBBR_SENT
{
			...
			throws Exception
	{
		...
		try{
			...
			String UPDATE_MHI_SQL_Oracle ="update mhi_msg_hdr_inter set mhi_msg_stat =10 where TO_CHAR(mhi_crtn_date,'YYYY-MM-DD')='2018-12-12' and mhi_next_addrs like 'BARB%' and mhi_msg_stat =6";
			...
			System.out.println(i+"Messages sucessfully updated");
